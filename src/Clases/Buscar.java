...
Connection con2 = null;
    ...
    private void initComponents() {
        ...
        JT_TablaHistorial.setFont(new java.awt.Font("Courier New", 1, 14)); // NOI18N
        JT_TablaHistorial.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID PRODUCTO", "NOMBRE", "PRECIO", "CANTIDAD", "ID_PROVEEDOR", "CODIGO"
            }
        ));
        ...
        jLabel2.setText(" BUSQUEDA PRODUCTO");
    ...
    private void buscartodoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscartodoKeyPressed
        ...
        try
        {
            ...
            while (rs.next())
            {
                ...
                registros[4] = rs.getString("Id_proveedores");
