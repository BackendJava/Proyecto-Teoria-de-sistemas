...
public final class BuscarProveedor extends javax.swing.JInternalFrame {
...
Connection con2 = null;
    ...
    public void vaciarTabla(){
        String titulos[] = {"ID_PROVEEDOR", "NOMBRE", "TELEFONO", "DIRECCION", "CORREO"};
    ...
    private void initComponents() {
        ...
        JT_TablaHistorial.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID PROVEEDOR", "NOMBRE", "TELEFONO", "DIRECCION", "CORREO"
            }
        ));
        ...
        jLabel2.setText("BUSQUEDA PROVEEDORES");
    ...
    private void buscartodoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscartodoKeyPressed
        ...
        String sql = "SELECT * FROM proveedores WHERE nombre_proveedor LIKE '%" + buscartodo.getText() + "%'";
        model = new DefaultTableModel(null, titulos);
        Conexion conect1 = new Conexion();
